 ...
 *
 * الخانة هنا **بالكتابة أو اللصق** للرقم. القراءة بالكاميرا في مركز
 * المسح (`/scan`)، وهي هناك مش هنا عن قصد: المحطة دي شاشة **عملية
 * واحدة** ماشية قدام العامل، والكاميرا بتاخد نص الشاشة. اللي جاي
 * بباندل جديد بيفتح «مسح» من الشريط العلوي.
 */
