  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        ...
        {/*
          الصفر هنا له سببين مختلفين تمامًا، وخلطهم كذب: يا إما مافيش
          مرتجع أصلًا، يا إما في مرتجع لسه مااتسوّاش فتكلفته مااتقرّرتش.
        */}
        <p className="mt-1 text-xs text-muted-foreground">
          {scope.recallCost > 0
            ? "مجموع تسويات المرتجعات المربوطة بالاستدعاء وبنود تكلفتها."
            : scope.returnedQty > 0
              ? `رجع ${qty(scope.returnedQty, 0)} قطعة بس لسه مااتسوّتش، فتكلفتها مااتقرّرتش. الصفر ده «لسه مش محسوب» مش «ببلاش».`
