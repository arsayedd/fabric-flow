...
export type Factory = {
   ...
   * مساحة تجريبية.
   *
   * الفرق مش شكلي: الداتا التجريبية بتتولّد بأرقام مترابطة عشان الناس
   * تستعرض النظام، وبيبقى فيها زرار يرجّعها لأصلها. الزرار ده لو اشتغل
   * على مساحة حقيقية بيمسح شغل مصنع، فالعلم ده هو اللي بيمنع ده، وهو
   * كمان اللي بيخلي الشريط الأصفر يبان فوق كل شاشة.
   */
  demo?: boolean;
};
