...
export const NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      item("/health", "صحة النظام", "settings", null),
...
export const QUICK_ACTIONS: QuickAction[] = [
  ...
  { key: "lay", label: "فرشة قص", to: "/cutting?new=1", icon: Scissors, perm: "production", action: "create" },
  { key: "subcontract", label: "إذن تشغيل خارجي", to: "/outsourcing?new=1", icon: Truck, perm: "purchasing", action: "create" },
  { key: "supply", label: "أمر توريد", to: "/supply?new=1", icon: PackageSearch, perm: "purchasing", action: "create" },
