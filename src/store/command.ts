 ...
 * **الالتزام بمواعيد التوريد والمرتجعات مش مسجّلين** — فمش داخلين
 * في الدرجة، والكارت بيقول كده بالنص.
 */
...
export const DASHBOARD_GAPS: Gap[] = [
  ...
  { label: "نوع العيب وسببه", needs: "تصنيف عيوب على تسجيل المرحلة — دلوقتي بنعرف الكمية مش النوع" },
  { label: "طاقة كل مرحلة وكل خط لوحده", needs: "طاقة على مستوى المرحلة — دلوقتي الطاقة للمصنع كله" },
  { label: "الالتزام بمواعيد الموردين", needs: "ميعاد توريد متوقع على أمر الشراء مقابل تاريخ الاستلام" },
