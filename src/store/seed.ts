...
export function demoDb(): Db {
  ...
  const returns: Db["returns"] = [
    ret("ret-1", rcode(1), {
      ...
      settleAmount: 2000,
      costs: [
        { id: "rc-1", kind: "shipping_in", amount: 150, note: "شحن الرجوع من مخزن العميل" },
        { id: "rc-2", kind: "inspection", amount: 80, note: "فحص ١٢٠ قطعة للتأكد من باقي الشحنة" },
      ],
    ...
    ret("ret-2", rcode(2), {
      ...
      deliveryId: "d6",
      orderId: "o2",
      /* الحالة الوحيدة المربوطة بباندل في الديمو — عشان سلسلة التتبع تبان شغّالة */
      bundleId: "bn-2",
      status: "settled",
    ...
    ret("ret-7", rcode(7), {
      ...
      unitValue: 82,
      settleAmount: 800,
      costs: [{ id: "rc-3", kind: "shipping_in", amount: 300, note: "شحن رجوع الرولات" }],
    ...
    ret("ret-8", rcode(8), {
      ...
      condition: "defective",
      reason: "quality",
      reasonNote: "التطريز مزحزح عن مكانه في الصدر",
      problem: "embroidery",
      origin: "operation",
      ...
      resolution: "repair",
      unitValue: 150,
      inspectedAt: at(addDays(today, -6), "11:00"),
      inspectedBy: "m-sup",
      settledAt: at(addDays(today, -6), "14:00"),
      settledBy: "m-owner",
      notes: "اتفقنا نعيد الطبع ونرجّعها بدل الخصم",
    }),
    ret("ret-9", rcode(9), {
      source: "customer",
      ...
      condition: "defective",
      reason: "quality",
      reasonNote: "زراير ناقصة في الكم",
      problem: "accessory",
      origin: "line",
      rootCause: "rush",
      color: "أبيض",
      ...
      resolution: "repair",
      unitValue: 250,
      inspectedAt: at(addDays(today, -20), "10:00"),
      inspectedBy: "m-sup",
      settledAt: at(addDays(today, -20), "12:00"),
      settledBy: "m-owner",
      notes: "اتصلحت واترجّعت في نفس الأسبوع",
    }),
  ];

  /*
   * أوامر الإصلاح: واحد خلص ورجع للعميل، وواحد لسه تحت الفحص. الاتنين
   * محتاجين يكونوا موجودين عشان شاشة الجودة تعرض دورة حياة كاملة مش
   * حالة واحدة.
   */
  const repairs: Db["repairs"] = [
    {
      id: "rep-1",
      factoryId: FID,
      code: `REP-${year}-000001`,
      returnId: "ret-9",
      date: addDays(today, -19),
      qty: 10,
      problem: "accessory",
      workerId: "w3",
      operationId: op("تعبئة"),
      rate: 6,
      minutes: 95,
      materials: [{ id: "rm-1", materialId: mat("أزرار"), qty: 40, unitCost: 1.5 }],
      status: "shipped",
      startedAt: at(addDays(today, -19), "09:00"),
      finishedAt: at(addDays(today, -19), "10:35"),
      qtyPassed: 10,
      qtyFailed: 0,
      qcAt: at(addDays(today, -19), "11:00"),
      qcBy: "m-sup",
      qcNote: "",
      shippedAt: at(addDays(today, -18), "09:00"),
      cancelReason: null,
      createdAt: new Date().toISOString(),
      createdBy: "m-sup",
      notes: "",
    },
    {
      id: "rep-2",
      factoryId: FID,
      code: `REP-${year}-000002`,
      returnId: "ret-8",
      date: addDays(today, -5),
      qty: 24,
      problem: "embroidery",
      workerId: "w4",
      operationId: op("تطريز"),
      rate: 11,
      minutes: 240,
      materials: [],
      status: "qc",
      startedAt: at(addDays(today, -5), "08:30"),
      finishedAt: at(addDays(today, -5), "12:30"),
      qtyPassed: 0,
      qtyFailed: 0,
      qcAt: null,
      qcBy: null,
